...
const ProductForm = () => {
    ...
    const [selectedFile, setSelectedFile] = useState(null); //se guarda la imagen cargada
    const [showModal, setShowModal] = useState(false); //controla la apertura y cierre de la ventana flotante
    ...
    /**
     * Maneja el cambio de archivo en el imput de la imagen
     * Setea el file y genera una url temporal para preview
